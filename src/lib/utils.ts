...
export function getAppState(
  ...
  const beforeDate = sp.beforeDate ? parse(sp.beforeDate, "yyyy-MM-dd", new Date()) : undefined;
  const afterDate = sp.afterDate ? parse(sp.afterDate, "yyyy-MM-dd", new Date()) : undefined;
